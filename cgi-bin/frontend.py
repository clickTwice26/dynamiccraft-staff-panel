...
#                         <input type="radio" id="radioApple" name="status" value="start">
...
def staff_panel(username, token):
    userdir = constant.userdir+f"{username}/{username}.json"
    userJSON = open(userdir,"r")
    userJSONdata = json.load(userJSON)
    userJSON.close()
    currentstatus = userJSONdata["currentstatus"]
    print(f"""
  ...
  <a class="active" href="reportbug.html">Report A Bug</a>
      ...
      <div class="mainBOX">
          <div class="attendenceBOX">
              ...
              <div class="aS-box">
                  <form action="/cgi-bin/staffpanel.py" method="post" class="atform">
                    <hr>
                      <div class="radio-toolbar">
                          <input type="radio" id="radioApple" name="status" value="online">
                          <label for="radioApple">Start</label>
                      
                          <input type="radio" id="radioBanana" name="status" value="offline">
                          <label for="radioBanana">End</label>
